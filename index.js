...
comment in javaScript are used to explain the code in javaScript :
...
// Declare a string variable named `greeting` and set it to "Hello, World!" var greeting = "Hello, World!":
